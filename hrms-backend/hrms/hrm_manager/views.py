...
def edit_staff(request, staff_id=1):
    ...
    if request.method == 'POST':
        ...
        staff.institutional_email = request.POST.get('institutional_email', staff.institutional_email)
        staff.profile_pic = request.FILES.get('profile_pic', staff.profile_pic)
        ...
        staff.shelf_location_number = request.POST.get('shelf_location_number', staff.shelf_location_number)
        staff.shelf_call_number = request.POST.get('shelf_call_number', staff.shelf_call_number)
